...
const PRO_FEATURES = [
  ...
  { label: "Done-for-you marketing", sub: "we run campaigns on your behalf to grow your client base" },
];
...
export function ProWaitlistCard() {
  ...
  return (
    <div className="border border-gold/40 p-8 flex flex-col gap-6 relative hover:border-gold/70 hover:bg-gold/5 transition-colors">
